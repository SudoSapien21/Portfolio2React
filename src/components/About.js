...
function About() {
  return (
    ...
    <h2>About Me</h2>
      ...
      <p>I was born and raised on the Southside of Chicago. When I graduated from High School, I decided to attend college, where I received my bachelor's degree in business. 
